...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 03-Set-2022 às 01:37
...
(67, '', '', '', '', 0),
(68, '', '', '', '', 0),
(69, 'João', 'joao@joao.com', '113213213221', 'São Paulo', 132121),
(70, 'João', 'joao@joao.com', '113213213221', 'São Paulo', 2147483647);
--
...
INSERT INTO `db_contatos` (`codigo`, `nome`, `email`, `telefone`, `foto`) VALUES
...
CREATE TABLE IF NOT EXISTS `tb_contatos` (
  ...
  `telefone` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `foto` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`codigo`)
...
INSERT INTO `tb_contatos` (`codigo`, `nome`, `email`, `telefone`, `foto`) VALUES
(15, 'João lula', ' da luivito', '11 909645909090', 'imgs/cara.jpg'),
(14, 'João', 'eric@eric.eric', '11 90909090', 'imgs/cara.jpg'),
(12, 'João', 'joao@joao.com', '113213213221', 'imgs/download.jpg');
COMMIT;
